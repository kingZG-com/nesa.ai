                            ...
                            <div class="p-5 flex flex-col flex-1 bg-white relative z-20">
                               ...
                               {{-- Footer Card --}}
                                <div class="mt-auto flex items-center justify-between pt-4 border-t border-slate-100">
                                    ...
                                    <button class="w-9 h-9 rounded-xl bg-slate-50 group-hover:bg-indigo-600 flex items-center justify-center text-slate-400 group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-indigo-200">
